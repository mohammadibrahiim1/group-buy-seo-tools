      ...
      <section>
        <div className="header-section">
          <div className="text-center p-40">
            <div>
              <h1 className="text-5xl ">There's a smarter way to do SEO.</h1>
              <p>
                ...
                everyone can afford.
                <br />
                India, Bangladesh, Pakistan, Nepal, United States, Saudi Arabia,
                Malaysia, and many more countries peoples also can purchase our
                service.
                <br /> Our maximum tools have simple access system (One click to
                access system) - hope you'll like this system!
              </p>
            </div>
            {/* <div>
